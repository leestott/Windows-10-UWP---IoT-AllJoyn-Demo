...
extern PCSTR c_lightbulbIntrospectionXml;

ref class lightbulbProducer;

public interface class IlightbulbProducer
{
    event Windows::Foundation::TypedEventHandler<lightbulbProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    event Windows::Foundation::TypedEventHandler<lightbulbProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<lightbulbProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<lightbulbProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class lightbulbProducer sealed : [Windows::Foundation::Metadata::Default] IlightbulbProducer
{
public:
    lightbulbProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~lightbulbProducer();

    // The implementation of IlightbulbService that will handle method calls and property requests.
    property IlightbulbService^ Service
    {
        IlightbulbService^ get() { return m_serviceInterface; }
        void set(IlightbulbService^ value) { m_serviceInterface = value; }
    }

    // Used to send signals or register functions to handle received signals.
    property lightbulbSignals^ Signals
    {
        lightbulbSignals^ get() { return m_signals; }
    }
    
    // This event will fire whenever this producer is stopped.
    virtual event Windows::Foundation::TypedEventHandler<lightbulbProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    
    // This event will fire whenever the producer loses the session that it created.
    virtual event Windows::Foundation::TypedEventHandler<lightbulbProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    
    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<lightbulbProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<lightbulbProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
...
private:
    static void CallSwitchHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallGetLocationHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallGetStatusHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    ...
    lightbulbSignals^ m_signals;
    IlightbulbService^ m_serviceInterface;
