...
public interface class IlightbulbConsumer
{
    event Windows::Foundation::TypedEventHandler<lightbulbConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<lightbulbConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<lightbulbConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class lightbulbConsumer sealed  : [Windows::Foundation::Metadata::Default] IlightbulbConsumer
{
public:
    lightbulbConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~lightbulbConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<lightbulbJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ lightbulbWatcher^ watcher);

    // Call the switch method
    Windows::Foundation::IAsyncOperation<lightbulbSwitchResult^>^ SwitchAsync(_In_ bool interfaceMemberOn);
    // Call the getLocation method
    Windows::Foundation::IAsyncOperation<lightbulbGetLocationResult^>^ GetLocationAsync();
    // Call the getStatus method
    Windows::Foundation::IAsyncOperation<lightbulbGetStatusResult^>^ GetStatusAsync();
    ...
    virtual event Windows::Foundation::TypedEventHandler<lightbulbConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<lightbulbConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<lightbulbConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
